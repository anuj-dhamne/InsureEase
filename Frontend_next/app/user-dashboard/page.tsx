              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="p-4 rounded-lg border bg-muted/50">
                    ...
                    <button className="bg-primary text-primary-foreground px-4 py-2 rounded-md">Start New Claim</button>
                  </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="p-4 rounded-lg border bg-muted/50">
                    ...
                    <button className="bg-primary text-primary-foreground px-4 py-2 rounded-md">Upload Document</button>
                  </div>
