    ...
    <footer className="bg-muted/40 border-t">
      <div className="container py-12 px-4 mx-auto">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <span className="text-muted-foreground">support@insureease.com</span>
              </li>
              <li className="flex items-start">
                <MapPin className="h-5 w-5 mr-2 text-primary" />
                <span className="text-muted-foreground">
                  123 Insurance Plaza, Financial District, New York, NY 10004
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground mb-4 md:mb-0">© 2023 InsureEase. All rights reserved.</p>
          <div className="flex space-x-4">
